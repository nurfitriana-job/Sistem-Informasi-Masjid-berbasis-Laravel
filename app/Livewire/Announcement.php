...
use App\Actions\FilamentAnnounce;
...
class Announcement extends Component
{
    ...
    protected static string $view = 'livewire.announcement.announcement-wrapper';
    ...
    public function getUnreadNotificationsData()
    {
        ...
        return $this->getUnreadNotificationsQuery()->latest()->take(1)->get();
    }
