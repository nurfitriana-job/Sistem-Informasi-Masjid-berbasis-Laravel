...
return [
    ...
    'profile' => [
        ...
        'browser_sessions' => [
            'title' => 'Sesi Peramban',
            'heading' => 'Sesi Peramban',
            'subheading' => 'Kelola sesi aktif Anda.',
            'label' => 'Sesi Peramban',
            'content' => 'Jika perlu, Anda dapat keluar dari semua sesi peramban Anda di semua perangkat. Beberapa sesi terbaru Anda terdaftar di bawah ini; namun, daftar ini mungkin tidak lengkap. Jika Anda merasa akun Anda telah dibobol, Anda juga harus memperbarui kata sandi Anda.',
            'device' => 'Perangkat ini',
            'last_active' => 'Terakhir aktif',
            'logout_other_sessions' => 'Keluar dari Sesi Peramban Lainnya',
            'logout_heading' => 'Keluar dari Sesi Peramban Lainnya',
            'logout_description' => 'Silakan masukkan kata sandi Anda untuk mengonfirmasi bahwa Anda ingin keluar dari sesi peramban lainnya di semua perangkat Anda.',
            'logout_action' => 'Keluar dari Sesi Peramban Lainnya',
            'incorrect_password' => 'Kata sandi yang Anda masukkan salah. Silakan coba lagi.',
            'logout_success' => 'Semua sesi peramban lainnya telah berhasil keluar.',
        ],
        'personal_info' => [
