...
jQuery(document).ready(function (e) {
    e.isFunction(e.fn.owlCarousel) &&
        ...
        jQuery(".mobile-nav .menu-item-has-children").on("click", function (e) {
            jQuery(this).hasClass("active")
                ...
                : (jQuery(".mobile-nav .menu-item-has-children").removeClass(
                      "active"
                  ),
    ...
    jQuery(".search-box-outer").length &&
    ...
    jQuery(".accordion-item .heading").on("click", function (e) {
        e.preventDefault(),
            jQuery(this).closest(".accordion-item").hasClass("active")
                ? jQuery(".accordion-item").removeClass("active")
                : (jQuery(".accordion-item").removeClass("active"),
                  jQuery(this).closest(".accordion-item").addClass("active"));
        var t = $(this).next();
        t.slideToggle(600),
            jQuery(".accordion-item .content").not(t).slideUp("fast");
    }),
    $(function () {
        $(window).scroll(function () {
            $("h2[data-max]").each(function () {
