@php
    ...
    if (Schema::hasTable('settings')) {
        ...
        $googleAnalytics = $settings?->google_analytics ?? null;
        $extraJavascript = $settings?->extra_javascript ?? null;
...
<head>
    ...
    <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id='{{ $googleAnalytics ?? 'G-BTG8VW8BFT' }}'"></script>
    <script>
        ...
        gtag('config', '{{ $googleAnalytics ?? 'G-BTG8VW8BFT' }}');
    </script>
